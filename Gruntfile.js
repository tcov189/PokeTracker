module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {            
            proj: {
                src  : ['<%= jsPath %>third_party/*.js', '<%= jsPath %>alter_catch_status.js', '<%= jsPath %>load_data.js', '<%= jsPath %>dropdowns.js', '<%= jsPath %>get_version.js', '<%= jsPath %>generate_html.js', '<%= jsPath %>tab-group.js', '<%= jsPath %>svg_test.js'],
            ...
            pokedex: {
                src  : ['<%= jsPath %>third_party/*.js', '<%= jsPath %>alter_catch_status.js', '<%= jsPath %>generate_pokedex.js', '<%= jsPath %>filter.js', '<%= jsPath %>svg_test.js'],
