...
//Location Constuctor 
function Location(name, walk_pkmn, walk_tg_pkmn, walk_sw_pkmn, yf_pkmn, rf_pkmn, pf_pkmn, shaking_pkmn, horde_pkmn, surfing_pkmn, old_rod_pkmn, good_rod_pkmn, super_rod_pkm, rock_smash_pkmn, gift_pkmn, static_pkmn, next, previous) {
    "use strict";
    this.name = name;
    this.walk_pkmn = walk_pkmn;
    this.walk_tg_pkmn = walk_tg_pkmn;
    this.walk_sw_pkmn = walk_sw_pkmn;    
    this.yf_pkmn = yf_pkmn;
    this.rf_pkmn = rf_pkmn;
    this.pf_pkmn = pf_pkmn;    
    this.shaking_pkmn = shaking_pkmn;
    this.horde_pkmn = horde_pkmn;
    this.surfing_pkmn = surfing_pkmn;
    this.old_rod_pkmn = old_rod_pkmn;
    this.good_rod_pkmn = good_rod_pkmn;
    this.super_rod_pkmn = super_rod_pkm;
    this.rock_smash_pkmn = rock_smash_pkmn;
    this.gift_pkmn = gift_pkmn;
    this.static_pkmn = static_pkmn;
    this.next = next;
...
Luminose_City = new Location(
    ...
    //Gift
    [
        [Bulbasaur, 'Prof. Sycamore'],
        [Charmander, 'Prof. Sycamore'],
        [Squirtle, 'Prof. Sycamore']

    ],
    //Static
    'None',
    ['Route 5', 'Route 14'],
    ['Route 4', 'Route 13', 'Route 16']
);

Camphrier_Town = new Location(
    "Camphrier Town",
    //Walk
    'None',
    //TG
...
//Static
'None',
['Frost Cavern', 'Route 17', 'Route 16'],
['Route 15']
);

Cyllage_City= new Location(
"Cyllage City",
//Walk
'None',
//WtG
...
var Coumarine_City = new Location(
"Coumarine City",
//Walk
'None',
//WtG
...
var Couriway_Town= new Location(
"Couriway Town",
//Walk
'None',
//WtG
...
//Static
'None',
['Team Flare HQ', 'Route 18'],
['Route 17']
);


var Shalour_City = new Location(
    'Shalour City',
    //Walking
    'None',
    //TG
...
Route_4 = new Location(
    ...
    [
        [Combee, '30%'],
        [Flabebe, '30% (Yellow Pedal)'],
        [Ledyba, '10%'],
        [Budew, '10%'],
        [Skitty, '10%'],
        [Ralts, '5%'],
        [Flabebe, '4% (Orange Pedal)'],
        [Flabebe, '1% (White Pedal)']
        
    ],
    //RF
    [
        [Ledyba, '30%'],
        [Flabebe, '30% (Red Pedal)'],
        [Skitty, '10%'],
        [Budew, '10%'],
        [Combee, '10%'],
        [Ralts, '5%'],
...
//Static
'None',
['Ambrette Town', 'Cyllage City'],
['Connecting Cave']
);

Route_9 = new Location(
"Route 9",
//Walk
[
    [Hippopotas, '40%'],
...
//Static
'None',
['Lost Hotel', 'Dendemille Town'],
['Laverre City']
);

var Route_16 = new Location(
"Route 16",
//Walk
'None',
//WtG
...
//Static
'None',
['Terminus Cave', 'Couriway Town'],
['Anistar City']
);

var Route_19 = new Location(
"Route 19",
//Walk
'None',
//WtG
