...
function generateHTML (){
    ...
    for (var h = 0; h < locationInfo.next.length; h++){
        $('#loc_next').append('<button type="button" id="' + locationInfo.next[h] + '" onclick=\'toNextLoc("' + locationInfo.next[h] + '");\'>'+ locationInfo.next[h] +'</button>');
    }
